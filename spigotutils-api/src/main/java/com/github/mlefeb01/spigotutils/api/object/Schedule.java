 ...
 * <p>
 * Upon creation of a Schedule, an O(n log n) preprocess occurs where the given collection of {@link HourMinute} is streamed
 ...
 * the head of the deque is the next {@link HourMinute} that will occur relative to when the sort occurs. This O(n log n)
